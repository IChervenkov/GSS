...
public class SearchHelmet extends AppCompatActivity {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(() -> {
                    ...
                    Toast.makeText(SearchHelmet.this, "Failed to read bike data", Toast.LENGTH_SHORT).show();
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (response.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        Toast.makeText(SearchHelmet.this, "Bike not found", Toast.LENGTH_SHORT).show();
                    });
                }
            }
        });
    ...
    private void loadHelmetData(String bikeId) {
        ...
        Request request = new Request.Builder()
                .url("https://bunker.bg/searchHelmet")
                .post(body)
                .build();
