...
Future<void> gssInventoryMessagingBackgroundHandler(
  RemoteMessage message,
) async {
  await InventoryNotificationService.ensureFirebaseReady();
}

class InventoryNotificationService {
  const InventoryNotificationService._();
  ...
  static Future<void> configure() async {
    ...
    FirebaseMessaging.onBackgroundMessage(
      gssInventoryMessagingBackgroundHandler,
    );
  ...
  static Future<void> registerDevice(InventoryApiClient api) async {
    if (!await ensureFirebaseReady()) return;
