...
class _AppRootState extends State<AppRoot> {
  ...
  late final InventoryApiClient _api = InventoryApiClient(store: _store);
  bool _booting = true;
  ...
  Future<void> _bootstrap() async {
    ...
    if (authenticated) {
      unawaited(InventoryNotificationService.registerDevice(_api));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return InventoryOperationsScreen(
      api: _api,
      onLogout: _logout,
