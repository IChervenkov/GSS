  ...
  Widget _brandPanel(BuildContext context, bool compact) {
    return Column(
      ...
      children: [
        ...
        Text(
          'Manage bikes, helmets, NFC lookup, soldier assignments, rentals, returns, JWT sessions, 2FA, logout, and realtime updates from one hardened mobile console.',
          style: Theme.of(
            context,
        ...
        const Wrap(
          ...
          children: [
            ...
            CapabilityChip(icon: Icons.lock_outline, label: 'Secure storage'),
          ],
        ),
      ],
    );
