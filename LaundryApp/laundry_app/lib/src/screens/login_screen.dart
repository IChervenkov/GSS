  ...
  Widget _brandPanel(BuildContext context, bool compact) {
    return Column(
      ...
      children: [
        ...
        Text(
          'Track bag inventory, status flow, RFID lookup, soldier possession, report history, JWT sessions, 2FA, logout, realtime updates, and Android app updates from one mobile console.',
          style: Theme.of(
            context,
