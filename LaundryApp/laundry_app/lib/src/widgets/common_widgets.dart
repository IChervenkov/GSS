...
class StatusChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = switch (status) {
      'pick_up' => const Color(0xff15803d),
      'in_soldier' => const Color(0xff475569),
      'drop_off' => const Color(0xffb45309),
      'laundry_facility' => const Color(0xff2563eb),
      'ready_to_pick_up' => const Color(0xff0f766e),
