...
class NativeBridge {
  ...
  static const _methods = MethodChannel('gss_laundry/native');
  static const _rfidEvents = EventChannel('gss_laundry/rfid');
  ...
  static Future<void> showLaundryStatusNotification({
    required String bagCode,
    required String status,
    String? soldierName,
  }) async {
    await _methods.invokeMethod<void>('showLaundryStatusNotification', {
      'bagCode': bagCode,
      'status': status,
